 ...
 * @className ApprovalRejectionTest
 */
public class ApprovalRejectionTest {
    ...
    @Test(dependsOnMethods = {"approvalPendingList"},description = "自建供应商审批驳回")
    public void selfSupplierApprovalRejectedTest(){
        JSONObject param = JSONUtil.createObj();
        param.put("approvalEmployeeId", approvalEmployeeId);
        param.put("remarks", "测试驳回");
        param.put("status", 5);
